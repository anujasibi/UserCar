...
public class recyclersource extends RecyclerView.Adapter<recyclersource.MyViewHolder> {
    ...
    public recyclersource(Context ctx, ArrayList<RecyclerPojo> recyclerPojos){
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,carbysource.class);
