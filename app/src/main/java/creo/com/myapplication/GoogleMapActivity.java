...
public class GoogleMapActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener , OnMapReadyCallback, TaskLoadedCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GoogleMapActivity.this,choosecar.class));
            }
        });
    ...
    public void onLocationChanged(Location location) {
     ...
     //   sessionManager.setUpdatelat(Double.toString(location.getLatitude()));
     //   sessionManager.setUpdateLong(Double.toString(location.getLongitude()));
        ...
        //    String s=getIntent().getExtras().get("lat").toString();
        //    String l=getIntent().getExtras().get("long").toString();
        String s=sessionManager.getUpdatelat();
        String l=sessionManager.getUpdateLong();
