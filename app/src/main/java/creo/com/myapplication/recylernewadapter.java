...
public class recylernewadapter extends RecyclerView.Adapter<recylernewadapter.MyViewHolder> {
    ...
    public recylernewadapter(Context ctx, ArrayList<RecyclerPojo> recyclerPojos){
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context,cardet.class);
